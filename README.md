...
<li>hide the true shape of the lesion<li>
<li>confuse machine learning models<li>
<li>make the image look noisy or unclear<li>
<li>affect accuracy during training<li>
